...
export default function CreatePage() {
  ...
  if (!session) {
    return (
      <EditableSiteShell>
        <main className="min-h-screen bg-[#f5f7f5] px-4 py-14 text-[#25211f] sm:px-6 lg:px-0">
          <section className="mx-auto grid max-w-[1192px] gap-8 rounded-md border border-black/10 bg-white p-7 shadow-[0_18px_50px_rgba(15,23,42,0.06)] md:grid-cols-[0.9fr_1.1fr] md:p-10">
            <div className="flex h-full min-h-72 items-center justify-center rounded-md bg-[#25211f] text-white">
            ...
            <div className="self-center">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link href="/login" className="inline-flex items-center gap-2 rounded-md bg-[#00a651] px-6 py-3 text-sm font-black text-white">Login <ArrowRight className="h-4 w-4" /></Link>
                <Link href="/signup" className="inline-flex items-center gap-2 rounded-md border border-black/10 bg-white px-6 py-3 text-sm font-black">Register</Link>
              </div>
            </div>
          </section>
        </main>
    ...
    <EditableSiteShell>
      <main className="min-h-screen bg-[#f5f7f5] text-[#25211f]">
        <section className="mx-auto max-w-[1192px] px-4 py-10 sm:px-6 lg:px-0 lg:py-12">
          <div className="grid gap-8 rounded-md border border-black/10 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)] lg:grid-cols-[0.85fr_1.15fr] lg:p-8">
            <aside>
            ...
            <form onSubmit={submit} className="rounded-md border border-black/10 bg-[#f5f7f5] p-5 sm:p-7">
              ...
              <div className="mt-6 grid gap-4">
                ...
                <textarea className={`${fieldClass} min-h-48`} value={body} onChange={(event) => setBody(event.target.value)} placeholder="Services, address, hours, contact notes, and profile description" required />
              </div>
              ...
              <button type="submit" className="mt-5 inline-flex h-12 w-full items-center justify-center gap-2 rounded-md bg-[#00a651] px-6 text-sm font-black uppercase tracking-[0.18em] text-white transition hover:-translate-y-0.5">
