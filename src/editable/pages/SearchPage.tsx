...
const locationOf = (post: SitePost) => plainText(getContent(post).location, 120) || plainText(getContent(post).address, 120) || plainText(getContent(post).city, 120) || 'Worldwide'
