...
const inputClass = 'h-12 rounded-md border border-black/15 bg-white px-4 text-base font-bold text-[#25211f] outline-none transition placeholder:text-slate-500 focus:border-[#00a651]'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[#00a651] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
